...
object PrefUtil {
    ...
    fun getFavTbIndx(ctx: Context): Int {
        var indx: Int?=0
        indx = get(ctx, AppConstants.PREF_KEY_FAV_INDX, indx as Any, AppConstants.PREF_NAME_DATAS) as Int?
        indx?:return 0
        indx+=1
        put(ctx, AppConstants.PREF_KEY_FAV_INDX, indx, AppConstants.PREF_NAME_DATAS)
        return indx
    }
}
